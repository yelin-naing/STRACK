...
`,ya=(e,n)=>s`
  ...
  background: ${e==="—"?n?"#404040":"#d1d5db":H2(e)};
`,wa=s`
  font-weight: 800;
  font-variant-numeric: tabular-nums;
  white-space: nowrap;
`,_i=e=>s`
  ...
  font-size: 0.92rem;
  color: ${e?"#9ca3af":"#6b7280"};
`;function va(e){const n=Number(e);return Number.isFinite(n)?`${Math.round(n*10)/10}/100`:"0/100"}function xc(e){const n=Number(e);return Number.isFinite(n)?n>=70?"D":n>=60?"M":n>=40?"P":"F":"—"}function H2(e){switch(e){case"D":return"#22c55e";case"M":return"#38bdf8";case"P":return"#f59e0b";case"F":return"#f87171";default:return"#71717a"}}function Zm(e){const n=new Map;return Array.isArray(e)&&e.forEach(i=>{const o=String(i.assessment_id??"");if(!o)return;const c=Number(i.weight);Number.isFinite(c)&&c>0&&n.set(o,c)}),n}function Y2(e){if(!Array.isArray(e))return null;let n=0;return e.forEach(i=>{const o=Number(i.weight);Number.isFinite(o)&&o>0&&(n+=o)}),Math.round(n*10)/10}function K2(e,n){const i=Zm(n),o=i.size>0;let c=0,l=0;for(const g of e){if(String(g.mark_status||"")==="not_marked")continue;const y=String(g.assessment_id||""),w=Number(g.score??0),P=i.get(y);P==null||!Number.isFinite(P)||P<=0||(c+=w*P,l+=P)}if(o&&l>0){const g=Math.round(c/l*10)/10;return{avg:g,band:xc(g),mode:"weighted"}}const u=e.filter(g=>String(g.mark_status||"")!=="not_marked");if(!u.length)return null;const b=u.reduce((g,y)=>g+Number(y.score??0),0)/u.length,v=Math.round(b*10)/10;return{avg:v,band:xc(v),mode:"simple"}}function V2(e,n){const i=e.get(String(n||""));return i==null||!Number.isFinite(i)?"—":`${Math.round(Number(i)*10)/10}%`}function Cd(e){const n=Number(e);return Number.isFinite(n)?n>=70?"#22c55e":n>=60?"#38bdf8":n>=40?"#f59e0b":"#f87171":"#71717a"}function G2({darkMode:e,userEmail:n}){const[i,o]=a.useState(!0),[c,l]=a.useState(""),[u,p]=a.useState([]);a.useEffect(()=>{if(!n){o(!1),p([]);return}let v=!1;return(async()=>{o(!0),l("");try{const y=await(await fetch(`${P2}/backend/assessment_scores.php?user_email=${encodeURIComponent(n)}&t=${Date.now()}`,{cache:"no-store"})).json().catch(()=>({}));if(v)return;if(!y.success){l(String(y.error||"Could not load grades.")),p([]);return}const w=Array.isArray(y.bars_by_course)?y.bars_by_course:[];p(w)}catch{v||(l("Could not reach the server."),p([]))}finally{v||o(!1)}})(),()=>{v=!0}},[n]);const b=a.useMemo(()=>[...u].sort((v,g)=>String(v.course_code||"").localeCompare(String(g.course_code||""),void 0,{sensitivity:"base"})),[u]);return r("div",{css:B2,children:[r("div",{css:s`display:flex;align-items:center;gap:0.55rem;`,children:[t(jo,{"aria-hidden":!0,style:{width:"1.85rem",height:"1.85rem",color:"#6366f1",flexShrink:0}}),t("h1",{css:O2,children:"Assignments & grades"})]}),r("p",{css:I2(e),children:[t("strong",{children:"Weight"})," is each assessment share of the module (your lecturer sets these to total 100%)."," ",t("strong",{children:"Module overall"})," uses those weights for completed items (same as lecturer Performance). Not marked rows are excluded. Bands: D (70+), M (60–69), P (40–59), F (under 40)."]}),i?t("p",{css:_i(e),children:"Loading…"}):c?t("p",{css:_i(e),children:c}):b.length===0?t("div",{css:$d(e),children:t("p",{css:_i(e),style:{margin:0},children:"No grades have been published for you yet. When your module leaders save marks in STRACK, they will show up here grouped by module."})}):b.map(v=>{const g=Array.isArray(v.marks)?v.marks:[],y=Array.isArray(v.assessment_weights)?v.assessment_weights:[],w=Zm(y),P=Y2(y),x=K2(g,y),A=[v.course_code,v.course_name].filter(Boolean).join(" — ")||"Module";return r("article",{css:$d(e),children:[t("h2",{css:k2,children:A}),r("p",{css:F2(e),children:[g.length," assessment",g.length===1?"":"s",P!=null&&P>0?` · Weights total ${P}%`:"",x!=null?` · Module overall ${va(x.avg)} (${x.band})${x.mode==="simple"?" — simple average (weights not published yet)":""}`:g.length>0?" · Complete at least one assessment to see module overall":""]}),g.length===0?t("p",{css:_i(e),style:{margin:0},children:"No individual marks listed for this module."}):t("div",{css:U2(e),children:r("table",{css:W2,children:[t("thead",{children:r("tr",{children:[t("th",{css:ss(e),children:"Assessment"}),t("th",{css:ss(e),children:"Weight"}),t("th",{css:ss(e),children:"Status"}),t("th",{css:ss(e),children:"Your mark"}),t("th",{css:ss(e),children:"Band"})]})}),t("tbody",{children:g.map((_,L)=>{const z=String(_.label||_.assessment_id||"Assessment").trim(),W=String(_.assessment_id||""),F=String(_.mark_status||"")==="not_marked",V=F?"—":xc(_.score);return r("tr",{children:[t("td",{css:is(e),children:t("span",{css:s`font-weight:600;`,children:z})}),t("td",{css:is(e),children:t("span",{css:s`
                                  font-weight: 700;
                                  font-variant-numeric: tabular-nums;
                                  color: ${e?"#d4d4d4":"#374151"};
                                `,children:V2(w,W)})}),t("td",{css:is(e),children:t("span",{css:s`
                                  font-weight: 700;
                                  font-size: 0.85rem;
                                  color: ${F?e?"#a3a3a3":"#6b7280":"#059669"};
                                `,children:F?"Not marked":"Completed"})}),t("td",{css:is(e),children:F?t("span",{css:[wa,s`color: ${e?"#737373":"#9ca3af"};`],children:"—"}):t("span",{css:[wa,s`color: ${Cd(_.score)};`],children:va(_.score)})}),t("td",{css:is(e),children:t("span",{css:ya(V,e),children:V})})]},`${v.course_id}-${W}-${L}`)})}),t("tfoot",{children:r("tr",{children:[t("td",{css:os(e),children:"Module overall"}),t("td",{css:os(e),children:P!=null&&P>0?`${P}%`:"—"}),t("td",{css:os(e)}),t("td",{css:os(e),children:x!=null?t("span",{css:[wa,s`color: ${Cd(x.avg)};`],children:va(x.avg)}):t("span",{css:s`color: ${e?"#737373":"#9ca3af"};`,children:"—"})}),t("td",{css:os(e),children:x!=null?t("span",{css:ya(x.band,e),children:x.band}):t("span",{css:ya("—",e),children:"—"})})]})})]})})]},v.course_id)})]})}const xa="/strack/".replace(/\/$/,""),J2="#6366f1",Z2=s`
  position: relative;
`,q2=(e,n)=>s`
  position: relative;
  width: 44px;
...
`,ry=e=>s`
  ...
  font-size: 0.72rem;
  color: ${e?"#9ca3af":"#6b7280"};
`;function sy(e){const n=new Date(e);if(Number.isNaN(n.getTime()))return"";const i=Date.now()-n.getTime(),o=Math.floor(i/6e4);if(o<1)return"just now";if(o<60)return`${o}m ago`;const c=Math.floor(o/60);if(c<24)return`${c}h ago`;const l=Math.floor(c/24);return l<7?`${l}d ago`:n.toLocaleDateString()}const iy=(e,n)=>s`
  position: absolute;
  top: calc(100% + 0.5rem);
...
`;function mo({darkMode:e,userEmail:n,placement:i="default"}){const{simulatedDnd:o}=Km(),c=a.useRef(null),[l,u]=a.useState(!1),[p,b]=a.useState(!1),[v,g]=a.useState([]),[y,w]=a.useState(0),P=async()=>{if(!n){g([]),w(0);return}b(!0);try{const L=await(await fetch(`${xa}/backend/notifications.php?email=${encodeURIComponent(n)}&limit=40`,{cache:"no-store"})).json();L.success&&(g(Array.isArray(L.notifications)?L.notifications:[]),w(Number(L.unread_count)||0))}catch{g([]),w(0)}finally{b(!1)}};a.useEffect(()=>{o&&u(!1)},[o]),a.useEffect(()=>{if(!n||o)return;P();const _=window.setInterval(P,45e3);return()=>window.clearInterval(_)},[n,o]),a.useEffect(()=>{!l||o||P()},[l,o]),a.useEffect(()=>{const _=L=>{c.current&&(c.current.contains(L.target)||u(!1))};return document.addEventListener("mousedown",_),()=>document.removeEventListener("mousedown",_)},[]);const x=async _=>{try{await fetch(`${xa}/backend/notifications.php`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:n,id:_})})}catch{}g(L=>L.map(z=>z.id===_?{...z,is_read:!0}:z)),w(L=>Math.max(0,L-1))},A=async()=>{try{await fetch(`${xa}/backend/notifications.php`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:n,mark_all:!0})})}catch{}g(_=>_.map(L=>({...L,is_read:!0}))),w(0)};return r("div",{css:Z2,ref:c,children:[r("button",{type:"button",css:q2(e,o),onClick:()=>{o||u(_=>!_)},"aria-label":o?"Notifications (Do Not Disturb — panel disabled)":"Notifications",title:o?"Notifications are simulated as muted while the study timer runs.":"Notifications",children:[o?t($m,{style:{width:22,height:22},"aria-hidden":!0}):t(dp,{style:{width:22,height:22},"aria-hidden":!0}),!o&&y>0?t("span",{css:X2,children:y>9?"9+":y}):null]}),l&&!o?r("div",{css:iy(e,i),children:[r("div",{css:Q2(e),children:[t("h3",{css:M2,children:"Notifications"}),t("button",{type:"button",css:ey,onClick:A,disabled:y===0,children:"Mark all read"})]}),t("div",{css:ty,children:p?t("div",{css:Sa(e,!1),children:t("p",{css:$a(e),children:"Loading..."})}):v.length===0?t("div",{css:Sa(e,!1),children:t("p",{css:$a(e),children:"No notifications yet."})}):v.map(_=>r("button",{type:"button",css:[Sa(e,!_.is_read),s`
                      width: 100%;
                      text-align: left;
                      border: none;
                      cursor: pointer;
                      color: inherit;
                    `],onClick:()=>{_.is_read||x(_.id)},children:[t("p",{css:ny,children:_.title||"Notification"}),t("p",{css:$a(e),children:_.message||""}),t("p",{css:ry(e),children:sy(_.created_at)})]},_.id))})]}):null]})}const oy="(min-width: 768px)",ay="(max-width: 767.98px)";function Gc(){const[e,n]=a.useState(!1),i=a.useCallback(()=>n(!1),[]);return a.useEffect(()=>{const o=window.matchMedia(oy),c=()=>{o.matches&&n(!1)};return o.addEventListener("change",c),()=>o.removeEventListener("change",c)},[]),a.useEffect(()=>{const o=window.matchMedia(ay);if(e&&o.matches){const c=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=c}}},[e]),{mobileMenuOpen:e,setMobileMenuOpen:n,closeMenu:i}}const ho="0.35s ease",Jc=e=>s`
  position: relative;
  min-height: 100vh;
  min-height: 100dvh;
...
`,cs="/strack/".replace(/\/$/,""),nn="0.35s ease",cy=s`
  display: flex;
  align-items: center;
  justify-content: space-between;
  gap: 0.5rem;
...
`,qy=e=>s`
  ...
  cursor: pointer;
`;function Xy({darkMode:e,userEmail:n}){const[i,o]=a.useState(new Date),[c,l]=a.useState([]),[u,p]=a.useState([]),[b,v]=a.useState(!0),[g,y]=a.useState(cn(new Date)),[w,P]=a.useState(null),[x,A]=a.useState(!1),[_,L]=a.useState(!1),[z,W]=a.useState({course_id:"",title:"",description:"",due_date:cn(new Date),due_time:"23:59",location:"Online"}),F=a.useMemo(()=>{const j=new Date;return j.setHours(0,0,0,0),j},[]),V=a.useMemo(()=>{const j=i.getFullYear(),E=i.getMonth();return{from:cn(new Date(j,E,1)),to:cn(new Date(j,E+1,0))}},[i]);a.useEffect(()=>{let j=!0;async function E(){try{const[C,X]=await Promise.all([fetch(`${ls}/backend/lecturers.php?t=${Date.now()}`,{cache:"no-store"}),fetch(`${ls}/backend/courses.php?t=${Date.now()}`,{cache:"no-store"})]),J=await C.json(),G=await X.json();if(!j)return;const ye=(J.success?J.lecturers||[]:[]).find(he=>String(he.email||"").trim().toLowerCase()===String(n||"").trim().toLowerCase())||null;P(ye),p(G.success?G.courses||[]:[])}catch{if(!j)return;P(null),p([])}}return E(),()=>{j=!1}},[n]),a.useEffect(()=>{let j=!0;async function E(){v(!0);try{const X=await(await fetch(`${ls}/backend/timetable.php?from=${encodeURIComponent(V.from)}&to=${encodeURIComponent(V.to)}`)).json();if(!j)return;l(X.success?X.entries||[]:[])}catch{if(!j)return;l([])}finally{j&&v(!1)}}return E(),()=>{j=!1}},[V.from,V.to]);const B=a.useMemo(()=>{if(!w)return[];const j=String(w.lecturer_id||"").trim();return u.filter(E=>String(E.lecturer_id||"").trim()===j)},[u,w]),R=a.useMemo(()=>{if(!w)return[];const j=new Set(B.map(E=>Number(E.id)));return c.filter(E=>{if(E.entry_type==="class"){const J=Number(E.course_id);return Number.isFinite(J)&&J>0&&j.has(J)}const C=E.course_id!=null&&E.course_id!==""?Number(E.course_id):NaN;return!Number.isFinite(C)||C<=0||j.has(C)?!0:Array.isArray(E.lecturers)&&E.lecturers.some(J=>Number(J.id)===Number(w.id))})},[c,w,B]),q=a.useMemo(()=>{const j={};for(const E of R)j[E.entry_date]||(j[E.entry_date]=[]),j[E.entry_date].push(E);return Object.keys(j).forEach(E=>j[E].sort((C,X)=>C.start_time.localeCompare(X.start_time))),j},[R]),H=q[g]||[],Q=q[cn(F)]||[],ce=a.useMemo(()=>R.filter(E=>E.entry_date>cn(F)||E.entry_date===cn(F)&&E.start_time>="00:00:00").sort((E,C)=>`${E.entry_date} ${E.start_time}`.localeCompare(`${C.entry_date} ${C.start_time}`)).slice(0,5),[R,F]),oe=a.useMemo(()=>Ty(i),[i]),ie=i.toLocaleDateString(void 0,{month:"long",year:"numeric"}),ue=Dd(g).toLocaleDateString(void 0,{weekday:"long",month:"long",day:"numeric",year:"numeric"}),N=()=>o(j=>new Date(j.getFullYear(),j.getMonth()-1,1)),M=()=>o(j=>new Date(j.getFullYear(),j.getMonth()+1,1)),ee=async()=>{if(!(!w||!z.course_id||!z.title.trim()||!z.due_date||!z.due_time)){L(!0);try{const j={entry_type:"event",course_id:Number(z.course_id),event_title:`Assignment Due: ${z.title.trim()}`,event_description:z.description.trim(),entry_date:z.due_date,start_time:z.due_time,end_time:zy(z.due_time),room_location:(z.location||"").trim()||"Online",lecturer_account_ids:[Number(w.id)]},C=await(await fetch(`${ls}/backend/timetable.php`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(j)})).json();if(!C.success){window.alert(C.error||"Could not save assignment due date");return}A(!1),W(G=>({...G,title:"",description:"",due_time:"23:59",location:"Online"}));const J=await(await fetch(`${ls}/backend/timetable.php?from=${encodeURIComponent(V.from)}&to=${encodeURIComponent(V.to)}`,{cache:"no-store"})).json();l(J.success?J.entries||[]:[])}catch{window.alert("Network error while saving assignment.")}finally{L(!1)}}};return r("div",{css:Ey,children:[r("div",{css:_a(e),children:[r("div",{css:jy,children:[t("h2",{css:Ry(e),children:ie}),r("div",{style:{display:"inline-flex",gap:"0.35rem",alignItems:"center"},children:[r("button",{type:"button",css:Td,onClick:()=>A(!0),children:[t(Bc,{})," Assignment Due Date"]}),t("button",{type:"button",css:zd(e),onClick:N,"aria-label":"Previous month",children:t(kc,{})}),t("button",{type:"button",css:zd(e),onClick:M,"aria-label":"Next month",children:t(Ic,{})})]})]}),r("div",{css:Py,children:[["Sun","Mon","Tue","Wed","Thu","Fri","Sat"].map(j=>t("div",{css:By(e),children:j},j)),oe.map((j,E)=>{if(j.type==="pad")return t("div",{css:Ed(e,!1,!1,!0)},`pad-${E}`);const C=cn(j.date),X=C===g,J=C===cn(F),G=(q[C]||[]).length>0;return r("div",{role:"button",tabIndex:0,css:Ed(e,X,J,!1),onClick:()=>y(C),onKeyDown:me=>me.key==="Enter"&&y(C),children:[t("div",{css:Oy,children:j.date.getDate()}),G?t("div",{css:Iy(X)}):t("div",{})]},C)})]}),r("h3",{css:ky(e),children:["Events on ",ue]}),b?t("p",{css:Ai(e),children:"Loading events..."}):H.length===0?t("p",{css:Ai(e),children:"No events for this date."}):H.map(j=>r("div",{css:jd(e,j.entry_type),children:[t("p",{css:Rd,children:j.entry_type==="class"?j.course_name||j.course_code:j.event_title}),r("div",{css:Aa(e),children:[r("span",{children:[t(lt,{}),Ca(j.start_time)]}),(j.room_location||"").trim()?r("span",{children:[t(Tn,{}),j.room_location]}):null]})]},j.id))]}),r("div",{css:Fy,children:[r("div",{css:_a(e),children:[r("h3",{css:Pd(e),children:[t(wn,{}),"Today's Schedule"]}),Q.length===0?t("p",{css:Ai(e),children:"No classes or deadlines today."}):Q.map(j=>r("div",{css:jd(e,j.entry_type),children:[t("p",{css:Rd,children:j.entry_type==="class"?j.course_name||j.course_code:j.event_title}),t("div",{css:Aa(e),children:r("span",{children:[t(lt,{}),Ca(j.start_time)]})})]},`today-${j.id}`))]}),r("div",{css:_a(e),children:[r("h3",{css:Pd(e),children:[t(lt,{}),"Upcoming"]}),ce.length===0?t("p",{css:Ai(e),children:"No upcoming entries."}):ce.map(j=>r("div",{css:Uy(e),children:[r("div",{style:{display:"flex",alignItems:"center",gap:"0.5rem"},children:[t("strong",{style:{fontSize:"0.92rem"},children:j.entry_type==="class"?j.course_name||j.course_code:j.event_title}),t("span",{css:Wy(e),children:j.entry_type==="class"?"Lecture":"Assignment"})]}),r("div",{css:Aa(e),style:{marginTop:"0.25rem"},children:[r("span",{children:[t(wn,{}),Dd(j.entry_date).toLocaleDateString(void 0,{month:"short",day:"numeric"})]}),r("span",{children:[t(lt,{}),Ca(j.start_time)]})]})]},`up-${j.id}`))]})]}),x?t("div",{css:Hy,onClick:()=>A(!1),children:r("div",{css:Yy(e),onClick:j=>j.stopPropagation(),children:[r("div",{css:Ky(e),children:[t("h3",{css:Vy(e),children:"Add Assignment Due Date"}),t("button",{type:"button",css:Gy(e),onClick:()=>A(!1),"aria-label":"Close",children:t(Fe,{})})]}),r("div",{css:Jy,children:[r("div",{css:gr,children:[t("label",{css:br(e),children:"Course"}),r("select",{css:pr(e),value:z.course_id,onChange:j=>W(E=>({...E,course_id:j.target.value})),children:[t("option",{value:"",children:"Select your course"}),B.map(j=>r("option",{value:String(j.id),children:[j.course_code," - ",j.course_name]},j.id))]})]}),r("div",{css:gr,children:[t("label",{css:br(e),children:"Assignment Title"}),t("input",{type:"text",css:pr(e),placeholder:"e.g. Lab Report 2",value:z.title,onChange:j=>W(E=>({...E,title:j.target.value}))})]}),r("div",{css:gr,children:[t("label",{css:br(e),children:"Description"}),t("textarea",{css:pr(e),style:{minHeight:"80px",resize:"vertical"},value:z.description,onChange:j=>W(E=>({...E,description:j.target.value}))})]}),r("div",{css:gr,children:[t("label",{css:br(e),children:"Due Date"}),t("input",{type:"date",css:pr(e),value:z.due_date,onChange:j=>W(E=>({...E,due_date:j.target.value}))})]}),r("div",{css:gr,children:[t("label",{css:br(e),children:"Due Time"}),t("input",{type:"time",css:pr(e),value:z.due_time,onChange:j=>W(E=>({...E,due_time:j.target.value}))})]}),r("div",{css:gr,children:[t("label",{css:br(e),children:"Location"}),t("input",{type:"text",css:pr(e),value:z.location,onChange:j=>W(E=>({...E,location:j.target.value}))})]})]}),r("div",{css:Zy(e),children:[t("button",{type:"button",css:qy(e),onClick:()=>A(!1),children:"Cancel"}),r("button",{type:"button",css:Td,onClick:ee,disabled:_,children:[t(En,{}),_?"Saving...":"Save Due Date"]})]})]})}):null]})}const Vt="/strack/".replace(/\/$/,""),Ht="#6366f1",Qy=Kc();function La(e){const[n,i,o]=String(e||"").split("-").map(Number);return new Date(n,(i||1)-1,o||1)}function Na(e){const n=e.getFullYear(),i=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${n}-${i}-${o}`}function Li(e){if(!e)return"";const[n,i]=String(e).split(":").map(Number),o=(n+11)%12+1,c=n>=12?"PM":"AM";return`${o}:${String(i||0).padStart(2,"0")} ${c}`}function Bd(e){const n=Number(e)||0;return n<1024?`${n} B`:n<1024*1024?`${(n/1024).toFixed(1)} KB`:`${(n/1024/1024).toFixed(1)} MB`}const My=s`width: 100%;`,ew=s`margin: 0; font-size: 1.5rem; font-weight: 700; line-height: 1.2;`,Ye=e=>s`margin: 0.2rem 0 .9rem; font-size: .95rem; color: ${e?"#9ca3af":"#6b7280"}; line-height: 1.4;`,tw=s`display: grid; grid-template-columns: repeat(4,minmax(0,1fr)); gap: .8rem; margin-bottom: .95rem; @media (max-width:1024px){grid-template-columns: repeat(2,minmax(0,1fr));}`,Po=e=>s`background:${e?"#262626":"#fff"}; border:1px solid ${e?"#404040":"#e5e7eb"}; border-radius:14px;`,Ni=e=>s`${Po(e)}; padding:.95rem;`,Di=e=>s`font-size:.78rem; letter-spacing:.03em; font-weight:700; color:${e?"#9ca3af":"#6b7280"}; text-transform: uppercase;`,zi=s`margin:.6rem 0 .15rem; font-size:1.85rem; font-weight:800; line-height:1.1;`,Ti=e=>s`margin:0; font-size:.95rem; color:${e?"#9ca3af":"#6b7280"};`,nw=e=>s`${Po(e)}; padding:.95rem; margin-bottom:.95rem;`,rw=s`display:flex; align-items:center; gap:.5rem; margin:0 0 .8rem; font-size:1.3rem; font-weight:700;`,sw=e=>s`border:1px solid ${e?"#404040":"#e5e7eb"}; border-radius:12px; padding:.9rem; margin-bottom:.8rem;`,iw=s`display:flex; align-items:center; gap:.5rem; flex-wrap:wrap;`,yr=e=>s`border:1px solid ${e?"#4b5563":"#e5e7eb"}; border-radius:10px; padding:.2rem .6rem; font-size:.95rem; font-weight:600;`,ow=s`margin-left:auto; border:1px solid #bbf7d0; color:#059669; background:#ecfdf5; border-radius:10px; padding:.2rem .6rem; font-size:.95rem; font-weight:700;`,aw=s`margin:.55rem 0 .2rem; font-size:1.8rem; font-weight:800; line-height:1.2;`,cw=e=>s`display:grid; grid-template-columns: repeat(3,minmax(0,1fr)); gap:.8rem; margin:.7rem 0 .6rem; font-size:.95rem; color:${e?"#d1d5db":"#374151"}; @media (max-width:900px){grid-template-columns:1fr;}`,lw=e=>s`height:10px; border-radius:999px; background:${e?"#404040":"#e5e7eb"}; overflow:hidden;`,dw=e=>s`height:100%; width:${Math.max(0,Math.min(100,e))}%; background:${Ht};`,uw=s`display:flex; gap:.55rem; margin-top:.75rem; flex-wrap:wrap;`,Od=s`border:none; background:${Ht}; color:#fff; border-radius:10px; padding:.48rem .82rem; font-weight:700; font-size:.95rem; cursor:pointer;`,Ei=e=>s`border:1px solid ${e?"#4b5563":"#e5e7eb"}; background:transparent; color:inherit; border-radius:10px; padding:.48rem .82rem; font-weight:700; font-size:.95rem; cursor:pointer;`,ji=s`position:fixed; inset:0; background:rgba(0,0,0,.45); display:flex; align-items:center; justify-content:center; z-index:1000; padding:1rem;`,Da=e=>s`${Po(e)}; width:100%; max-width:980px; max-height:90vh; overflow:auto;`,Ri=e=>s`display:flex; align-items:start; justify-content:space-between; padding:1rem; border-bottom:1px solid ${e?"#404040":"#e5e7eb"};`,Pi=s`margin:0; font-size:1.45rem; font-weight:800;`,Bi=e=>s`margin:.2rem 0 0; color:${e?"#9ca3af":"#6b7280"};`,Oi=e=>s`border:1px solid ${e?"#4b5563":"#d1d5db"}; background:transparent; width:38px; height:38px; border-radius:10px; cursor:pointer;`,Ii=s`padding:1rem;`,Id=e=>s`display:flex; align-items:center; justify-content:space-between; gap:.8rem; border:1px solid ${e?"#404040":"#e5e7eb"}; border-radius:10px; padding:.8rem; margin-bottom:.6rem;`,mw=e=>s`border:1px solid ${e?"#7f1d1d":"#fecaca"}; color:#dc2626; background:${e?"rgba(127,29,29,0.22)":"#fef2f2"}; border-radius:10px; padding:.4rem .65rem; font-weight:700; font-size:.85rem; cursor:pointer; display:inline-flex; align-items:center; gap:.35rem;`,kd=e=>s`display:flex; flex-wrap:wrap; align-items:center; gap:.55rem; margin-bottom:1rem; padding:.75rem; border-radius:10px; border:1px dashed ${e?"#525252":"#d1d5db"}; background:${e?"#1f1f1f":"#f9fafb"};`,za=e=>s`border:1px solid ${e?"#404040":"#e5e7eb"}; border-radius:10px; padding:.8rem; margin-bottom:.7rem;`,hw=e=>s`
  border: none;
  background: transparent;
  padding: 0;
  margin: 0;
...
`;function bw({darkMode:e,userEmail:n}){const[i,o]=a.useState([]),[c,l]=a.useState(null),[u,p]=a.useState([]),[b,v]=a.useState(!0),[g,y]=a.useState(null),[w,P]=a.useState(null),[x,A]=a.useState(null),[_,L]=a.useState([]),[z,W]=a.useState(!1),[F,V]=a.useState(""),[B,R]=a.useState(null),[q,H]=a.useState(!1),Q=a.useRef(null),[ce,oe]=a.useState(null),[ie,ue]=a.useState(""),[N,M]=a.useState(""),[ee,j]=a.useState(""),[E,C]=a.useState(""),[X,J]=a.useState([]),[G,me]=a.useState(!1),[ye,he]=a.useState(""),ze=h=>`${Vt}/backend/demo_assignment_submissions.php?download=1&submission_id=${encodeURIComponent(String(h))}&lecturer_email=${encodeURIComponent(n||"")}`,ve=(h,m)=>{m&&A(null),oe(h)},fe=h=>Array.isArray(h==null?void 0:h.students)?[...h.students].sort((m,$)=>String(m.full_name||"").localeCompare(String($.full_name||""))):[],Y=h=>`${Vt}/backend/course_resources.php?download=1&id=${h}&lecturer_email=${encodeURIComponent(n||"")}`;a.useEffect(()=>{if(!(w!=null&&w.id)||!n){J([]),he("");return}let h=!1;async function m(){me(!0),he("");try{const O=await(await fetch(`${Vt}/backend/demo_assignment_submissions.php?course_id=${encodeURIComponent(String(w.id))}&lecturer_email=${encodeURIComponent(n)}`,{cache:"no-store"})).json().catch(()=>({}));if(h)return;O.success?J(Array.isArray(O.submissions)?O.submissions:[]):he(O.error||"Could not load student uploads")}catch{h||he("Could not load student uploads")}finally{h||me(!1)}}return m(),()=>{h=!0}},[w==null?void 0:w.id,n]),a.useEffect(()=>{if(!(g!=null&&g.id)||!n){L([]),V("");return}let h=!0;async function m(){W(!0),V("");try{const O=await(await fetch(`${Vt}/backend/course_resources.php?course_id=${g.id}&lecturer_email=${encodeURIComponent(n)}`,{cache:"no-store"})).json();if(!h)return;O.success?L(O.resources||[]):V(O.error||"Could not load resources")}catch{h&&V("Network error")}finally{h&&W(!1)}}return m(),()=>{h=!1}},[g==null?void 0:g.id,n]);const re=async h=>{var $;const m=($=h.target.files)==null?void 0:$[0];if(h.target.value="",!(!m||!(g!=null&&g.id)||!n)){H(!0),V(""),R(null);try{const O=new FormData;O.append("file",m),O.append("course_id",String(g.id)),O.append("lecturer_email",n);const k=await(await fetch(`${Vt}/backend/course_resources.php`,{method:"POST",body:O})).json();if(!k.success){V(k.error||"Upload failed");return}const te=k.notifications||{};R({inApp:Number(te.in_app_created)||0});const $e=await(await fetch(`${Vt}/backend/course_resources.php?course_id=${g.id}&lecturer_email=${encodeURIComponent(n)}`,{cache:"no-store"})).json();$e.success&&L($e.resources||[])}catch{V("Upload failed")}finally{H(!1)}}},xe=async h=>{if(!(!n||!window.confirm("Remove this file for all students?"))){V("");try{const $=await(await fetch(`${Vt}/backend/course_resources.php`,{method:"DELETE",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:h,lecturer_email:n})})).json();if(!$.success){V($.error||"Delete failed");return}L(O=>O.filter(ne=>ne.id!==h))}catch{V("Delete failed")}}};a.useEffect(()=>{let h=!0;async function m(){v(!0);try{const $=new Date,O=new Date($);O.setMonth(O.getMonth()-6);const ne=new Date($);ne.setMonth(ne.getMonth()+6);const[k,te,Ce]=await Promise.all([fetch(`${Vt}/backend/lecturers.php?t=${Date.now()}`,{cache:"no-store"}),fetch(`${Vt}/backend/courses.php?t=${Date.now()}`,{cache:"no-store"}),fetch(`${Vt}/backend/timetable.php?from=${encodeURIComponent(Na(O))}&to=${encodeURIComponent(Na(ne))}`,{cache:"no-store"})]),$e=await k.json(),S=await te.json(),K=await Ce.json();if(!h)return;const le=($e.success?$e.lecturers||[]:[]).find(_e=>String(_e.email||"").trim().toLowerCase()===String(n||"").trim().toLowerCase())||null;l(le),o(S.success?S.courses||[]:[]),p(K.success?K.entries||[]:[])}catch{if(!h)return;l(null),o([]),p([])}finally{h&&v(!1)}}return m(),()=>{h=!1}},[n]);const Se=a.useMemo(()=>{if(!c)return[];const h=String(c.lecturer_id||"").trim();return i.filter(m=>String(m.lecturer_id||"").trim()===h)},[i,c]),D=a.useMemo(()=>Se.filter(h=>!(ie&&String(h.intake_month||"")!==ie||N&&String(h.intake_year??"")!==N||ee&&String(h.semester||"")!==ee||E&&String(h.course_study_year||"")!==E)),[Se,ie,N,ee,E]),ae=a.useMemo(()=>{const h=Na(new Date);return D.map(m=>{const $=Number(m.id),O=u.filter(S=>S.entry_type==="class"&&Number(S.course_id)===$).sort((S,K)=>`${S.entry_date} ${S.start_time}`.localeCompare(`${K.entry_date} ${K.start_time}`)),ne=u.filter(S=>S.entry_type==="event"&&Number(S.course_id)===$).sort((S,K)=>`${S.entry_date} ${S.start_time}`.localeCompare(`${K.entry_date} ${K.start_time}`)).map(S=>{let K="Upcoming";return S.entry_date<h?K="Past due":S.entry_date===h&&(K="Due today"),{id:S.id,title:S.event_title||"Assignment",description:S.event_description||"No description provided.",due:S.entry_date,dueTime:S.start_time,status:K}}),k=ne.filter(S=>S.status==="Past due").length,te=ne.length?Math.round(k/ne.length*100):0,Ce=O.find(S=>S.entry_date>=h)||null,$e=Number(m.enrolled_count)||(Array.isArray(m.students)?m.students.length:0);return{...m,meta:{instructor:m.lecturer_name||"TBA",enrolled:$e,description:`You teach ${m.course_name} (${m.course_code}) in ${m.department||"General"}.`,classes:O,assignments:ne,completedAssignments:k,nextLecture:Ce?`${La(Ce.entry_date).toLocaleDateString(void 0,{weekday:"short"})} ${Li(Ce.start_time)}`:"No upcoming session",progress:te}}})},[D,u]),ge=a.useMemo(()=>{const h=ae.length,m=ae.reduce((k,te)=>k+(Number(te.credits)||0),0),$=h?Math.round(ae.reduce((k,te)=>k+te.meta.progress,0)/h):0,O=ae.reduce((k,te)=>k+te.meta.completedAssignments,0),ne=ae.reduce((k,te)=>k+te.meta.assignments.length,0);return{totalCourses:h,totalCredits:m,avgProgress:$,pastDue:O,totalAssignments:ne}},[ae]),T=c?Se.length===0?"No courses are assigned to you yet.":D.length===0?"No courses match the selected filters.":"No courses are assigned to you yet.":"We could not match your account to a lecturer profile. Check that your email matches the staff record.";return r("div",{css:My,children:[t("h1",{css:ew,children:"My Courses"}),r("p",{css:Ye(e),children:["Modules you teach, timetable sessions, and assignment due dates. Open ",t("strong",{children:"Assignments"})," on a module to view due dates and to ",t("strong",{children:"see and download"})," files students upload from their Courses page (demo assignment submissions)."]}),c?r("div",{css:gw(e),role:"search","aria-label":"Filter courses",children:[t("span",{css:Ye(e),style:{margin:0,fontWeight:700},children:"Filters"}),t("select",{css:ki(e),value:ie,onChange:h=>ue(h.target.value),"aria-label":"Intake month",children:co.map(h=>t("option",{value:h.value,children:h.value?h.label:"Any month"},h.value||"all-m"))}),r("select",{css:ki(e),value:N,onChange:h=>M(h.target.value),"aria-label":"Intake year",children:[t("option",{value:"",children:"Any intake year"}),Qy.map(h=>t("option",{value:String(h),children:h},h))]}),t("select",{css:ki(e),value:ee,onChange:h=>j(h.target.value),"aria-label":"Semester",children:Gs.map(h=>t("option",{value:h.value,children:h.value?h.label:"Any semester"},h.value||"all-s"))}),t("select",{css:ki(e),value:E,onChange:h=>C(h.target.value),"aria-label":"Course study year",children:Or.map(h=>t("option",{value:h.value,children:h.value?h.label:"Any study year"},h.value||"all-y"))})]}):null,r("div",{css:tw,children:[r("div",{css:Ni(e),children:[t("p",{css:Di(e),children:"Total Courses"}),t("p",{css:zi,children:ge.totalCourses}),t("p",{css:Ti(e),children:"Your modules"})]}),r("div",{css:Ni(e),children:[t("p",{css:Di(e),children:"Total Credits"}),t("p",{css:zi,children:ge.totalCredits}),t("p",{css:Ti(e),children:"Teaching load"})]}),r("div",{css:Ni(e),children:[t("p",{css:Di(e),children:"Timeline"}),r("p",{css:zi,children:[ge.avgProgress,"%"]}),t("p",{css:Ti(e),children:"Past due dates"})]}),r("div",{css:Ni(e),children:[t("p",{css:Di(e),children:"Due dates"}),r("p",{css:zi,children:[ge.pastDue,"/",ge.totalAssignments]}),t("p",{css:Ti(e),children:"Past / total"})]})]}),r("section",{css:nw(e),children:[r("h2",{css:rw,children:[t(St,{style:{color:Ht,width:24,height:24}}),"Active Courses"]}),b?t("p",{children:"Loading courses..."}):ae.length===0?t("p",{children:T}):ae.map(h=>r("article",{css:sw(e),children:[r("div",{css:iw,children:[t("span",{css:yr(e),children:h.course_code}),r("span",{css:yr(e),children:[Number(h.credits)||0," Credits"]}),t("span",{css:yr(e),title:"Cohort intake",children:Xt(h)}),h.semester?t("span",{css:yr(e),children:h.semester}):null,h.course_study_year?t("span",{css:yr(e),children:Mt(h.course_study_year)}):null,t("span",{css:ow,children:"Active"})]}),t("h3",{css:aw,children:h.course_name}),t("p",{css:Ye(e),style:{marginBottom:".4rem"},children:h.department||"General"}),r("div",{css:cw(e),children:[r("button",{type:"button",css:hw(),onClick:()=>ve(h,!1),title:"View enrolled students",children:[t(kt,{"aria-hidden":!0})," Students: ",t("strong",{children:h.meta.enrolled})]}),r("span",{children:[t(lt,{})," Next: ",t("strong",{children:h.meta.nextLecture})]}),r("span",{children:[t(En,{})," Due dates: ",r("strong",{children:[h.meta.completedAssignments,"/",h.meta.assignments.length]})," ","past"]})]}),r("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:".3rem"},children:[t("span",{css:Ye(e),style:{margin:0},children:"Assignment timeline"}),r("strong",{children:[h.meta.progress,"%"]})]}),t("div",{css:lw(e),children:t("div",{css:dw(h.meta.progress)})}),r("div",{css:uw,children:[t("button",{type:"button",css:Od,onClick:()=>A(h),children:"View Course"}),t("button",{type:"button",css:Ei(e),onClick:()=>y(h),children:"Resources"}),t("button",{type:"button",css:Ei(e),onClick:()=>P(h),children:"Assignments"})]})]},h.id))]}),g?t("div",{css:ji,onClick:()=>y(null),children:r("div",{css:Da(e),onClick:h=>h.stopPropagation(),children:[r("div",{css:Ri(e),children:[r("div",{children:[t("h3",{css:Pi,children:"Course Resources"}),r("p",{css:Bi(e),children:["Materials for ",g.course_name]})]}),t("button",{type:"button",css:Oi(e),onClick:()=>y(null),children:t(Fe,{})})]}),r("div",{css:Ii,children:[t("input",{ref:Q,type:"file",accept:".pdf,.doc,.docx,.ppt,.pptx,.xls,.xlsx,.txt,.csv,.zip,.png,.jpg,.jpeg,.gif,.webp",css:s`display:none;`,onChange:re}),r("div",{css:kd(e),children:[r("button",{type:"button",css:Od,disabled:q,onClick:()=>{var h;return(h=Q.current)==null?void 0:h.click()},children:[t(wc,{style:{display:"inline",verticalAlign:"middle"}})," ",q?"Uploading…":"Upload file"]}),t("span",{css:Ye(e),style:{margin:0},children:"PDF, Office, images, zip — max 20 MB"})]}),F?t("p",{style:{color:"#dc2626",margin:"0 0 .75rem",fontSize:".9rem"},children:F}):null,B?r("div",{css:s`
                  ...
                  `,children:["Upload complete. In-app notifications created: ",t("strong",{children:B.inApp}),"."]}):null,z?t("p",{css:Ye(e),style:{margin:0},children:"Loading resources…"}):_.length===0?t("p",{css:Ye(e),style:{margin:0},children:"No files yet. Upload materials for students to download."}):_.map(h=>r("div",{css:Id(e),children:[r("div",{style:{display:"flex",alignItems:"center",gap:".75rem",minWidth:0},children:[t("span",{style:{width:42,height:42,borderRadius:8,background:"#eef2ff",display:"inline-flex",alignItems:"center",justifyContent:"center",color:Ht,flexShrink:0},children:t(En,{})}),r("div",{style:{minWidth:0},children:[t("strong",{style:{wordBreak:"break-word"},children:h.original_filename}),r("p",{css:Ye(e),style:{margin:".1rem 0 0"},children:[Bd(h.file_size),h.created_at?` · ${new Date(h.created_at.replace(" ","T")).toLocaleString(void 0,{dateStyle:"medium",timeStyle:"short"})}`:""]})]})]}),r("div",{style:{display:"flex",flexWrap:"wrap",gap:".45rem",flexShrink:0},children:[r("a",{href:Y(h.id),css:Ei(e),style:{textDecoration:"none"},children:[t(oo,{})," Download"]}),r("button",{type:"button",css:mw(e),onClick:()=>xe(h.id),children:[t(bn,{})," Remove"]})]})]},h.id))]})]})}):null,w?t("div",{css:ji,onClick:()=>P(null),children:r("div",{css:Da(e),onClick:h=>h.stopPropagation(),children:[r("div",{css:Ri(e),children:[r("div",{children:[t("h3",{css:Pi,children:"Course Assignments"}),r("p",{css:Bi(e),children:["Due dates for ",w.course_name]})]}),t("button",{type:"button",css:Oi(e),onClick:()=>P(null),children:t(Fe,{})})]}),r("div",{css:Ii,children:[r("div",{css:kd(e),style:{marginBottom:"1rem"},children:[t(wc,{style:{width:22,height:22,flexShrink:0,color:Ht},"aria-hidden":!0}),r("p",{css:Ye(e),style:{margin:0,flex:"1 1 12rem",lineHeight:1.45},children:[t("strong",{children:"Student uploads:"})," When students use ",t("strong",{children:"Courses → Assignments → Upload a demo file"}),", their files appear below. You can open or download each file here."]})]}),w.meta.assignments.length===0?t("p",{css:Ye(e),style:{margin:0},children:"No assignment due dates found for this course yet. Add them from the Calendar tab."}):w.meta.assignments.map((h,m)=>r("div",{css:za(e),children:[r("div",{style:{display:"flex",alignItems:"center",gap:".6rem",flexWrap:"wrap"},children:[t("h4",{style:{margin:0,fontSize:"1.5rem",fontWeight:800},children:h.title}),t("span",{css:yr(e),style:{color:h.status==="Past due"?"#059669":h.status==="Due today"?"#ca8a04":"#2563eb",borderColor:h.status==="Past due"?"#86efac":h.status==="Due today"?"#fde68a":"#bfdbfe",background:h.status==="Past due"?"#ecfdf5":h.status==="Due today"?"#fffbeb":"#eff6ff"},children:h.status})]}),t("p",{css:Ye(e),style:{marginTop:".3rem"},children:h.description}),r("p",{css:Ye(e),style:{marginTop:".15rem"},children:["Due: ",La(h.due).toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"}),h.dueTime?` · Time: ${Li(h.dueTime)}`:""]})]},`${h.title}-${m}`)),t("h4",{style:{margin:"1.25rem 0 0.5rem",fontSize:"1.05rem",fontWeight:800},children:"Uploaded assignment files"}),G?t("p",{css:Ye(e),style:{margin:0},children:"Loading student uploads…"}):ye?t("p",{css:Ye(e),style:{margin:0,color:"#dc2626"},children:ye}):X.length===0?r("p",{css:Ye(e),style:{margin:0},children:["No demo files uploaded for this module yet. Students submit from their ",t("strong",{children:"Courses"})," page."]}):X.map(h=>r("div",{css:Id(e),children:[r("div",{style:{minWidth:0},children:[t("strong",{style:{wordBreak:"break-word"},children:h.original_filename||"File"}),r("p",{css:Ye(e),style:{margin:".15rem 0 0"},children:[h.student_name||"Student",h.student_email?` · ${h.student_email}`:"",h.file_size!=null?` · ${Bd(h.file_size)}`:"",h.uploaded_at?` · ${new Date(String(h.uploaded_at).replace(" ","T")).toLocaleString(void 0,{dateStyle:"medium",timeStyle:"short"})}`:""]})]}),r("a",{href:ze(h.id),css:Ei(e),style:{textDecoration:"none",flexShrink:0},children:[t(oo,{"aria-hidden":!0})," Download"]})]},h.id))]})]})}):null,ce?t("div",{css:ji,onClick:()=>oe(null),children:r("div",{css:pw(e),onClick:h=>h.stopPropagation(),role:"dialog","aria-labelledby":"enrolled-modal-title",children:[r("div",{css:Ri(e),children:[r("div",{children:[t("h3",{id:"enrolled-modal-title",css:Pi,children:"Enrolled students"}),r("p",{css:Bi(e),children:[ce.course_name," (",ce.course_code,")"]})]}),t("button",{type:"button",css:Oi(e),onClick:()=>oe(null),"aria-label":"Close",children:t(Fe,{})})]}),t("div",{css:Ii,children:fe(ce).length===0?t("p",{css:Ye(e),style:{margin:0},children:"No students are enrolled in this module yet."}):fe(ce).map(h=>r("div",{css:fw(e),children:[t("strong",{style:{display:"block",marginBottom:"0.25rem"},children:h.full_name||"—"}),r("p",{css:Ye(e),style:{margin:0,display:"flex",alignItems:"center",gap:"0.35rem",flexWrap:"wrap"},children:[t(Oc,{style:{flexShrink:0,opacity:.85},"aria-hidden":!0}),h.email&&String(h.email).trim()?t("a",{href:`mailto:${String(h.email).trim()}`,css:s`
                    ...
                    `],onClick:()=>ve(x,!0),children:[t("p",{css:Ye(e),style:{margin:0},children:"Enrolled students"}),t("strong",{children:x.meta.enrolled}),t("p",{css:Ye(e),style:{margin:"0.35rem 0 0",fontSize:"0.82rem"},children:"Click to view names and emails"})]}),r("div",{css:za(e),children:[t("p",{css:Ye(e),style:{margin:0},children:"Next session"}),t("strong",{children:x.meta.nextLecture})]})]})]})]})}):null]})}const ds="/strack/".replace(/\/$/,""),po="#6366f1",yw={present:"Present",late:"Late",absent:"Absent"};function ww(){const e=new Date,n=e.getFullYear(),i=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${n}-${i}-${o}`}function vw(){const e=new Date,n=new Date(e),i=new Date(e);n.setDate(e.getDate()-365),i.setDate(e.getDate()+365);const o=c=>`${c.getFullYear()}-${String(c.getMonth()+1).padStart(2,"0")}-${String(c.getDate()).padStart(2,"0")}`;return{from:o(n),to:o(i)}}function Fd(e){const n=String(e||""),i=n.split(":");return i.length<2?n:`${i[0]}:${i[1]}`}function xw(e){const n=String(e||"").trim();if(!n)return"S";const i=n.split(/\s+/);return i.length<2?n.slice(0,2).toUpperCase():`${i[0][0]}${i[i.length-1][0]}`.toUpperCase()}function Sw(e){const n=["#6366f1","#8b5cf6","#0ea5e9","#14b8a6","#f97316","#ec4899"],i=String(e||"");let o=0;for(let c=0;c<i.length;c+=1)o=o*31+i.charCodeAt(c)>>>0;return n[o%n.length]}const $w=s`
  width: 100%;
`,Cw=s`
  display: flex;
  align-items: flex-start;
...
`,Fw=e=>s`
  ...
  text-align: center;
  padding: 1rem;
`;function Uw({darkMode:e,userEmail:n}){const[i,o]=a.useState(""),[c,l]=a.useState(""),[u,p]=a.useState([]),[b,v]=a.useState([]),[g,y]=a.useState(""),[w,P]=a.useState(""),[x,A]=a.useState({}),[_,L]=a.useState(!0),[z,W]=a.useState(!1),[F,V]=a.useState("");a.useEffect(()=>{let N=!0;async function M(){L(!0);try{const[ee,j]=await Promise.all([fetch(`${ds}/backend/lecturers.php?t=${Date.now()}`,{cache:"no-store"}),fetch(`${ds}/backend/courses.php?t=${Date.now()}`,{cache:"no-store"})]),E=await ee.json(),C=await j.json();if(!N)return;const J=(E.success?E.lecturers||[]:[]).find(ze=>String(ze.email||"").trim().toLowerCase()===String(n||"").trim().toLowerCase()),G=String((J==null?void 0:J.lecturer_id)||""),me=String((J==null?void 0:J.id)||"");o(G),l(me);const he=(C.success?C.courses||[]:[]).filter(ze=>String(ze.lecturer_id||"").trim()===G);p(he)}catch{if(!N)return;o(""),l(""),p([])}finally{N&&L(!1)}}return M(),()=>{N=!1}},[n]),a.useEffect(()=>{let N=!0;async function M(){if(!c&&u.length===0){v([]),P("");return}try{const ee=vw(),E=await(await fetch(`${ds}/backend/timetable.php?from=${encodeURIComponent(ee.from)}&to=${encodeURIComponent(ee.to)}&t=${Date.now()}`,{cache:"no-store"})).json();if(!N)return;const C=E.success?E.entries||[]:[],X=new Set(u.map(G=>String(G.id))),J=C.filter(G=>{if(G.entry_type!=="class")return!1;const me=Array.isArray(G.lecturers)?G.lecturers.some(he=>Number(he.id)===Number(c)):!1,ye=X.has(String(G.course_id||""));return me||ye});v(J)}catch{if(!N)return;v([])}}return M(),()=>{N=!1}},[u,c]),a.useEffect(()=>{P(N=>{const M=b.filter(ee=>String(ee.course_id||"")===String(g));return M.some(ee=>String(ee.id)===String(N))?N:M[0]?String(M[0].id):""})},[b,g]),a.useEffect(()=>{if(!w)return;const N=b.find(ee=>String(ee.id)===String(w)),M=(N==null?void 0:N.course_id)!=null?String(N.course_id):"";M&&M!==g&&y(M)},[b,w,g]);const B=a.useMemo(()=>u.find(N=>String(N.id)===String(g))||null,[u,g]),R=a.useMemo(()=>Array.isArray(B==null?void 0:B.students)?B.students:[],[B]),q=a.useMemo(()=>b.filter(N=>String(N.course_id||"")===String(g)),[b,g]),H=a.useMemo(()=>q.find(N=>String(N.id)===String(w))||null,[q,w]),Q=(H==null?void 0:H.entry_date)||ww(),ce=a.useMemo(()=>new Date(`${Q}T00:00:00`).toLocaleDateString(void 0,{weekday:"long",month:"long",day:"numeric",year:"numeric"}),[Q]);a.useEffect(()=>{if(!g||!w){A({});return}let N=!0;async function M(){try{const ee=new URLSearchParams({user_email:n,class_id:String(w)}),E=await(await fetch(`${ds}/backend/attendance_marks.php?${ee.toString()}`,{cache:"no-store"})).json();if(!N)return;E!=null&&E.success&&E.marks&&typeof E.marks=="object"?A(E.marks):A({})}catch{N&&A({})}}return M(),()=>{N=!1}},[w,g,n]);const oe=a.useMemo(()=>{const N=R.length,M=R.filter(j=>["present","late","absent"].includes(x[j.id])).length,ee=R.filter(j=>x[j.id]==="present").length;return{total:N,marked:M,present:ee}},[R,x]),ie=(N,M)=>{V(""),A(ee=>({...ee,[N]:M}))},ue=async()=>{if(!(!g||!w)){W(!0);try{const M=await(await fetch(`${ds}/backend/attendance_marks.php`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({user_email:n,class_id:Number(w),marks:x})})).json();if(!(M!=null&&M.success))throw new Error((M==null?void 0:M.error)||"Failed to save attendance");V(`Attendance saved for ${ce}.`),window.setTimeout(()=>V(""),2200)}catch{V("Could not save attendance to database."),window.setTimeout(()=>V(""),2200)}finally{W(!1)}}};return r("div",{css:$w,children:[r("div",{css:Cw,children:[r("div",{children:[t("h1",{css:_w,children:"Mark Attendance"}),t("p",{css:Aw(e),children:"Track student attendance for your classes"})]}),t("div",{css:Lw(e),"aria-hidden":!0,children:t(Ds,{style:{width:24,height:24}})})]}),r("section",{css:Ud(e),children:[t("h2",{css:Wd,children:"Select Module"}),t("p",{css:Hd(e),children:"Choose a module, then select one assigned class to mark attendance."}),r("div",{css:Nw,children:[r("select",{css:Yd(e),value:g,onChange:N=>y(N.target.value),disabled:_||u.length===0,children:[t("option",{value:"",children:"Select a module"}),u.map(N=>r("option",{value:String(N.id),children:[N.course_code," - ",N.course_name]},N.id))]}),r("select",{css:Yd(e),value:w,onChange:N=>P(N.target.value),disabled:!g||_||q.length===0,children:[t("option",{value:"",children:g?"Select an assigned class":"Select a module first"}),q.map(N=>r("option",{value:String(N.id),children:[N.course_code||"Class"," | ",N.entry_date," | ",Fd(N.start_time),"-",Fd(N.end_time)]},N.id))]})]}),g?r("div",{css:Dw(e),children:["Classes found: ",q.length,H?` | Class date: ${ce}`:""]}):null]}),!g||!w?t("div",{css:Fw(e),children:r("div",{children:[t(Zf,{style:{width:38,height:38,opacity:.5}}),t("h3",{css:s`margin: 0.75rem 0 0.35rem; font-size: 1.75rem;`,children:"Select module and class to begin"}),t("p",{css:Ta(e),children:"After choosing a module, select one assigned class to show enrolled students."})]})}):r(rt,{children:[r("section",{css:Ud(e),children:[r("div",{css:zw,children:[r("div",{children:[t("h2",{css:Wd,children:"Students"}),t("p",{css:Hd(e),children:"Mark attendance for each student"})]}),t("button",{type:"button",css:Tw,onClick:ue,children:z?"Saving...":"Save Attendance"})]}),R.map(N=>{const M=x[N.id]||"";return r("article",{css:Ew(e),children:[r("div",{css:jw,children:[t("span",{css:Rw(Sw(N.student_id||N.id)),children:xw(N.full_name)}),r("div",{children:[t("p",{css:Pw,children:N.full_name||"Unknown student"}),t("p",{css:Bw(e),children:N.student_id||"No student id"})]})]}),r("div",{css:Ow,children:[t("span",{css:Iw(e,M),children:M?yw[M]:"Not Marked"}),t("button",{type:"button",css:Kd(e,M==="present"),onClick:()=>ie(N.id,"present"),"aria-label":`Mark ${N.full_name} present`,children:t(Vn,{})}),t("button",{type:"button",css:Kd(e,M==="absent"),onClick:()=>ie(N.id,"absent"),"aria-label":`Mark ${N.full_name} absent`,children:t(Gf,{})})]})]},N.id)}),R.length===0?t("p",{css:Ta(e),children:"No students enrolled in this module yet."}):null,F?t("p",{css:s`margin: 0.6rem 0 0; font-size: 0.9rem; color: #059669; font-weight: 600;`,children:F}):null]}),r("section",{css:kw,children:[r("article",{css:Ea(e),children:[t("h3",{css:ja,children:"Total Students"}),t("p",{css:Ra,children:oe.total})]}),r("article",{css:Ea(e),children:[t("h3",{css:ja,children:"Marked for Class"}),t("p",{css:Ra,children:oe.marked})]}),r("article",{css:Ea(e),children:[t("h3",{css:ja,children:"Present"}),t("p",{css:Ra,children:oe.present})]})]})]}),!_&&!i?t("p",{css:Ta(e),style:{marginTop:"0.9rem"},children:"We could not match your account to a lecturer profile."}):null]})}const wr="/strack/".replace(/\/$/,""),Ww="0.25s ease",Hw=s`
  display: grid;
  gap: 1rem;
`,Yw=s`
  font-size: 1.5rem;
...
`,Wi=e=>s`
  color: ${e?"#9ca3af":"#6b7280"};
`;function ru(e){if(!e)return"";const n=new Date(e);return Number.isNaN(n.getTime())?String(e):n.toLocaleString([],{day:"numeric",month:"numeric",year:"numeric",hour:"numeric",minute:"2-digit"})}function Iv({darkMode:e,userEmail:n}){const[i,o]=a.useState(!1),[c,l]=a.useState(!1),[u,p]=a.useState(""),[b,v]=a.useState([]),[g,y]=a.useState([]),[w,P]=a.useState(""),[x,A]=a.useState(!1),[_,L]=a.useState(0),[z,W]=a.useState({}),[F,V]=a.useState(0),[B,R]=a.useState({course_id:"",title:"",content:""}),q=a.useMemo(()=>String(n||"").trim()!=="",[n]),H=()=>{R({course_id:"",title:"",content:""}),L(0),A(!1)},Q=a.useCallback(async()=>{if(q){o(!0),p("");try{const N=new URLSearchParams({user_email:n});w&&N.set("course_id",w);const ee=await(await fetch(`${Fi}/backend/announcements.php?${N.toString()}`,{cache:"no-store"})).json();if(!(ee!=null&&ee.success))throw new Error((ee==null?void 0:ee.error)||"Failed to load announcements");v(Array.isArray(ee.available_courses)?ee.available_courses:[]),y(Array.isArray(ee.announcements)?ee.announcements:[])}catch(N){p(N instanceof Error?N.message:"Failed to load announcements")}finally{o(!1)}}},[q,w,n]);a.useEffect(()=>{Q()},[Q]);const ce=async()=>{const N=B.title.trim(),M=B.content.trim();if(!N||!M||!q){p("Title and content are required.");return}l(!0),p("");try{const ee={user_email:n,course_id:B.course_id?Number(B.course_id):null,title:N,content:M},j=_>0?"PUT":"POST",C=await(await fetch(`${Fi}/backend/announcements.php`,{method:j,headers:{"Content-Type":"application/json"},body:JSON.stringify(_>0?{...ee,id:_}:ee)})).json();if(!(C!=null&&C.success))throw new Error((C==null?void 0:C.error)||"Failed to save announcement");H(),await Q()}catch(ee){p(ee instanceof Error?ee.message:"Failed to save announcement")}finally{l(!1)}},oe=N=>{A(!0),L(Number(N.id||0)),R({course_id:N.course_id?String(N.course_id):"",title:N.title||"",content:N.content||""})},ie=async N=>{if(!(!q||!N||!window.confirm("Delete this announcement?"))){l(!0),p("");try{const ee=new URLSearchParams({id:String(N),user_email:n}),E=await(await fetch(`${Fi}/backend/announcements.php?${ee.toString()}`,{method:"DELETE"})).json();if(!(E!=null&&E.success))throw new Error((E==null?void 0:E.error)||"Failed to delete announcement");await Q()}catch(ee){p(ee instanceof Error?ee.message:"Failed to delete announcement")}finally{l(!1)}}},ue=async N=>{if(!(!q||!N||!window.confirm("Delete this comment?"))){V(N),p("");try{const j=await(await fetch(`${Fi}/backend/announcement_comments.php`,{method:"DELETE",headers:{"Content-Type":"application/json"},body:JSON.stringify({user_email:n,comment_id:N})})).json();if(!(j!=null&&j.success))throw new Error((j==null?void 0:j.error)||"Failed to delete comment");await Q()}catch(ee){p(ee instanceof Error?ee.message:"Failed to delete comment")}finally{V(0)}}};return r("section",{css:dv,children:[r("header",{css:uv,children:[r("div",{children:[t("h1",{css:mv,children:"Class Announcements"}),t("p",{css:hv(e),children:"Post updates and communicate with your students"})]}),t("button",{type:"button",css:eu,onClick:()=>{A(!0),L(0),R({course_id:"",title:"",content:""})},children:"+ New Announcement"})]}),r("div",{css:fv(e),children:[t("label",{css:Ui,htmlFor:"lecturer-ann-course-filter",children:"Filter by course:"}),r("select",{id:"lecturer-ann-course-filter",css:tu(e),value:w,onChange:N=>P(N.target.value),children:[t("option",{value:"",children:"All Courses"}),b.map(N=>r("option",{value:N.id,children:[N.course_code," ",N.course_name?`- ${N.course_name}`:""]},N.id))]})]}),x?r("section",{css:pv(e),children:[t("strong",{children:_>0?"Edit announcement":"New announcement"}),t("label",{css:Ui,htmlFor:"lecturer-ann-course",children:"Course (optional):"}),r("select",{id:"lecturer-ann-course",css:tu(e),value:B.course_id,onChange:N=>R(M=>({...M,course_id:N.target.value})),children:[t("option",{value:"",children:"All Courses (General)"}),b.map(N=>r("option",{value:N.id,children:[N.course_code," ",N.course_name?`- ${N.course_name}`:""]},N.id))]}),t("label",{css:Ui,htmlFor:"lecturer-ann-title",children:"Title:"}),t("input",{id:"lecturer-ann-title",css:qm(e),value:B.title,onChange:N=>R(M=>({...M,title:N.target.value})),maxLength:255}),t("label",{css:Ui,htmlFor:"lecturer-ann-content",children:"Message:"}),t("textarea",{id:"lecturer-ann-content",css:gv(e),value:B.content,onChange:N=>R(M=>({...M,content:N.target.value}))}),r("div",{css:bv,children:[t("button",{type:"button",css:yv(e),onClick:H,disabled:c,children:"Cancel"}),t("button",{type:"button",css:eu,onClick:ce,disabled:c,children:_>0?"Update":"Post"})]})]}):null,u?t("p",{css:Wi(e),children:u}):null,i?t("p",{css:Wi(e),children:"Loading announcements..."}):null,!i&&g.length===0?t("p",{css:Wi(e),children:"No announcements yet. Create your first update."}):null,g.map(N=>{var M,ee,j;return r("article",{css:wv(e),children:[r("div",{css:vv,children:[r("div",{css:xv,children:[t("span",{css:Sv,children:N.course_code||"General"}),t("span",{css:$v(e),children:ru(N.created_at)})]}),N.editable?r("div",{css:Lv,children:[t("button",{type:"button",css:nu(!1),onClick:()=>oe(N),title:"Edit announcement","aria-label":"Edit announcement",children:t(Mf,{})}),t("button",{type:"button",css:nu(!0),onClick:()=>ie(N.id),title:"Delete announcement","aria-label":"Delete announcement",children:t(bn,{})})]}):null]}),t("h2",{css:Cv,children:N.title}),t("p",{css:_v(e),children:N.content}),r("div",{css:Av(e),children:[r("button",{type:"button",css:Nv(e),onClick:()=>W(E=>({...E,[N.id]:!E[N.id]})),children:[t(cp,{}),N.comment_count||0," comments"]}),r("span",{children:["👍 ",((M=N.reaction_counts)==null?void 0:M.like)||0," · ❤️ ",((ee=N.reaction_counts)==null?void 0:ee.love)||0," · 🎉"," ",((j=N.reaction_counts)==null?void 0:j.celebrate)||0]})]}),z[N.id]?t("div",{css:Dv,children:(N.comments||[]).length===0?t("div",{css:Wi(e),children:"No comments yet."}):(N.comments||[]).map(E=>r("div",{css:zv(e),children:[r("div",{css:Tv,children:[r("div",{css:Ev,children:[t("span",{css:jv,children:t(Pc,{})}),t("span",{css:Rv,children:E.student_name||"Student"}),t("span",{css:Pv(e),children:ru(E.created_at)})]}),E.can_delete?t("button",{type:"button",css:Ov,title:"Delete comment","aria-label":"Delete comment",onClick:()=>ue(E.id),disabled:F===E.id,children:t(bn,{})}):null]}),t("div",{css:Bv(e),children:E.comment_text})]},E.id))}):null]},N.id)})]})}const us="/strack/".replace(/\/$/,""),kv="#7c3aed",Fv="#8b5cf6",Uv="#94a3b8",Wv="#34d399",Hi={P:"#60a5fa",M:"#a78bfa",D:"#34d399",U:"#94a3b8"},Sr={onTime:"#22c55e",late:"#f97316",missing:"#ef4444"},Hv=s`
  display: flex;
  flex-direction: column;
  gap: 1rem;
  width: 100%;
...
`,ct=e=>s`
  ...
  font-size: 0.9rem;
  color: ${e?"#9ca3af":"#6b7280"};
`;function Qv(e,n,i,o){return!(n&&String((e==null?void 0:e.intake_year)??"")!==String(n)||i&&String((e==null?void 0:e.semester)||"")!==i||o&&String((e==null?void 0:e.course_study_year)||"")!==o)}const Vi=s`
  display: flex;
  flex-direction: column;
  gap: 0.35rem;
  margin-bottom: 0.75rem;
...
`,Cu=e=>s`
  ...
  text-align: center;
  color: ${e?"#9ca3af":"#6b7280"};
`,Es=8,sl=18,go=48,Xm=(sl-Es)*go;function X4(e){const n=e.getFullYear(),i=e.getMonth(),o=new Date(n,i,1),c=new Date(n,i+1,0),l=o.getDay(),u=c.getDate(),p=[];for(let b=0;b<l;b++)p.push({type:"pad",date:null});for(let b=1;b<=u;b++)p.push({type:"day",date:new Date(n,i,b)});for(;p.length%7!==0;)p.push({type:"pad",date:null});return p}function Q4(e){const n=wu(e.start_time),i=wu(e.end_time),o=Es*60,c=sl*60;if(i<=o||n>=c)return null;const l=Math.max(n,o),u=Math.min(i,c),p=(l-o)/60*go,b=Math.max((u-l)/60*go,28);return{top:p,height:b}}function M4({darkMode:e}){const[n,i]=a.useState("monthly"),[o,c]=a.useState(()=>new Date),[l,u]=a.useState(""),[p,b]=a.useState(""),[v,g]=a.useState([]),[y,w]=a.useState(!0),[P,x]=a.useState([]),[A,_]=a.useState([]),[L,z]=a.useState([]),[W,F]=a.useState(!1),[V,B]=a.useState(null),[R,q]=a.useState(!1),[H,Q]=a.useState({entry_type:"class",course_id:"",event_title:"",event_description:"",entry_date:"",start_time:"09:00",end_time:"11:00",room_location:"",lecturer_ids:[]}),ce=o.getTime(),{from:oe,to:ie}=a.useMemo(()=>e4(n,o),[n,ce]),ue=a.useCallback(async()=>{try{const[m,$,O]=await Promise.all([fetch(`${$r}/backend/courses.php`),fetch(`${$r}/backend/lecturers.php`),fetch(`${$r}/backend/departments.php`)]),ne=await m.json(),k=await $.json(),te=await O.json();ne.success&&x(ne.courses||[]),k.success&&_(k.lecturers||[]),te.success&&z(te.departments||[])}catch{x([]),_([]),z([])}},[]),N=a.useCallback(async()=>{w(!0);try{const $=await(await fetch(`${$r}/backend/timetable.php?from=${encodeURIComponent(oe)}&to=${encodeURIComponent(ie)}`,{cache:"no-store"})).json();$.success?g($.entries||[]):g([])}catch{g([])}finally{w(!1)}},[oe,ie]);a.useEffect(()=>{ue()},[ue]),a.useEffect(()=>{N()},[N]);const M=a.useMemo(()=>v.filter(m=>{if(l&&!(m.department&&m.department===l||m.lecturers&&m.lecturers.some(O=>O.department===l)))return!1;if(p){const $=parseInt(p,10);if(!(m.lecturers&&m.lecturers.some(ne=>ne.id===$)))return!1}return!0}),[v,l,p]),ee=a.useMemo(()=>{const m=new Set(L.map($=>$.name).filter(Boolean));return P.forEach($=>{$.department&&m.add($.department)}),Array.from(m).sort()},[L,P]),j=a.useMemo(()=>H.course_id?P.find(m=>String(m.id)===String(H.course_id)):null,[P,H.course_id]),E=a.useMemo(()=>ec(j,A),[j,A]),C=a.useMemo(()=>{if(n==="monthly")return o.toLocaleString(void 0,{month:"long",year:"numeric"});const m=$c(o),$=new Date(m);return $.setDate($.getDate()+6),`${Ot(m).replace(/-/g,"/")} – ${Ot($).replace(/-/g,"/")}`},[n,ce]),X=m=>{B(null);const $=Ot(m||new Date);Q({entry_type:"class",course_id:"",event_title:"",event_description:"",entry_date:$,start_time:"09:00",end_time:"11:00",room_location:"",lecturer_ids:[]}),F(!0)},J=m=>{B(m.id);const $=m.entry_type==="class"&&m.course_id?P.find(k=>Number(k.id)===Number(m.course_id)):null,O=new Set(ec($,A).map(k=>k.id)),ne=m.entry_type==="class"?(m.lecturers||[]).map(k=>k.id).filter(k=>O.has(k)):[];Q({entry_type:m.entry_type,course_id:m.course_id?String(m.course_id):"",event_title:m.event_title||"",event_description:m.event_description||"",entry_date:m.entry_date,start_time:In(m.start_time),end_time:In(m.end_time),room_location:m.room_location||"",lecturer_ids:ne}),F(!0)},G=()=>F(!1),me=m=>{Q($=>{const O=new Set($.lecturer_ids);return O.has(m)?O.delete(m):O.add(m),{...$,lecturer_ids:Array.from(O)}})},ye=async()=>{const m={entry_type:H.entry_type,course_id:H.entry_type==="class"?parseInt(H.course_id,10):0,event_title:H.event_title,event_description:H.event_description,entry_date:H.entry_date,start_time:H.start_time,end_time:H.end_time,room_location:H.room_location,lecturer_account_ids:H.entry_type==="class"?H.lecturer_ids:[]};if(H.entry_type==="class"&&!m.course_id){window.alert("Please select a module.");return}if(H.entry_type==="event"&&!m.event_title.trim()){window.alert("Please enter an event title.");return}q(!0);try{const $=`${$r}/backend/timetable.php`,O=V?{method:"PUT",body:JSON.stringify({id:V,...m})}:{method:"POST",body:JSON.stringify(m)},k=await(await fetch($,{...O,headers:{"Content-Type":"application/json"}})).json();if(!k.success){window.alert(k.error||"Could not save.");return}G(),N()}catch{window.alert("Network error.")}finally{q(!1)}},he=async m=>{if(window.confirm("Delete this timetable entry?"))try{const O=await(await fetch(`${$r}/backend/timetable.php?id=${m.id}`,{method:"DELETE"})).json();if(!O.success){window.alert(O.error||"Could not delete.");return}N()}catch{window.alert("Network error.")}},ze=()=>c(new Date),ve=()=>{c(n==="monthly"?m=>new Date(m.getFullYear(),m.getMonth()-1,1):m=>{const $=new Date(m);return $.setDate($.getDate()-7),$})},fe=()=>{c(n==="monthly"?m=>new Date(m.getFullYear(),m.getMonth()+1,1):m=>{const $=new Date(m);return $.setDate($.getDate()+7),$})},Y=H.entry_date?t4[yu(H.entry_date).getDay()]:"",re=a.useMemo(()=>{const m=new Date;return m.setHours(0,0,0,0),m},[]),xe=Ot(re),Se=a.useMemo(()=>X4(o),[ce,n]),D=a.useMemo(()=>{const m={};return M.forEach($=>{m[$.entry_date]||(m[$.entry_date]=[]),m[$.entry_date].push($)}),Object.keys(m).forEach($=>m[$].sort((O,ne)=>O.start_time.localeCompare(ne.start_time))),m},[M]),ae=a.useMemo(()=>Object.keys(D).sort().map($=>({date:$,items:D[$]})),[D]),ge=$c(o),T=Array.from({length:7},(m,$)=>{const O=new Date(ge);return O.setDate(O.getDate()+$),O}),h=Array.from({length:sl-Es},(m,$)=>Es+$);return r("div",{css:n4,children:[r("div",{css:r4,children:[r("div",{css:s4,children:[t("h1",{css:i4,children:"Timetable Management"}),t("p",{css:o4(e),children:"Manage class schedules and school events"})]}),r("div",{css:a4,children:[r("div",{css:c4(e),children:[r("button",{type:"button",css:nc(e,n==="monthly"),onClick:()=>i("monthly"),children:[t(Eo,{"aria-hidden":!0}),"Monthly"]}),r("button",{type:"button",css:nc(e,n==="weekly"),onClick:()=>i("weekly"),children:[t(Jf,{"aria-hidden":!0}),"Weekly"]}),r("button",{type:"button",css:nc(e,n==="list"),onClick:()=>i("list"),children:[t(rp,{"aria-hidden":!0}),"List"]})]}),r("button",{type:"button",css:l4,onClick:()=>X(null),children:[t(Bc,{"aria-hidden":!0}),"Add Entry"]})]})]}),r("div",{css:d4(e),children:[r("div",{css:vu,children:[t("label",{css:Rt(e),children:"Filter by Department"}),r("select",{css:Zi(e),value:l,onChange:m=>u(m.target.value),children:[t("option",{value:"",children:"All Departments"}),ee.map(m=>t("option",{value:m,children:m},m))]})]}),r("div",{css:vu,children:[t("label",{css:Rt(e),children:"Filter by Lecturer"}),r("select",{css:Zi(e),value:p,onChange:m=>b(m.target.value),children:[t("option",{value:"",children:"All Lecturers"}),A.map(m=>r("option",{value:String(m.id),children:[m.full_name," (",m.lecturer_id,")"]},m.id))]})]}),r("div",{css:u4,children:[t("button",{type:"button",css:xu(e),onClick:ve,"aria-label":"Previous",children:t(kc,{})}),t("button",{type:"button",css:m4(e),onClick:ze,children:"Today"}),t("button",{type:"button",css:xu(e),onClick:fe,"aria-label":"Next",children:t(Ic,{})}),t("span",{css:h4(e),children:C})]})]}),y?t("p",{css:Cu(e),children:"Loading timetable…"}):n==="monthly"?r("div",{css:f4(e),children:[tc.map(m=>t("div",{css:p4(e),children:m},m)),Se.map((m,$)=>{if(m.type==="pad")return t("div",{css:Su(e,!0,!1)},`pad-${$}`);const O=Ot(m.date),ne=O===xe,k=D[O]||[],te=k.slice(0,3),Ce=k.length-te.length;return r("div",{role:"button",tabIndex:0,css:Su(e,!1,ne),onClick:()=>X(m.date),onKeyDown:$e=>$e.key==="Enter"&&X(m.date),children:[r("div",{css:g4(e,ne),children:[m.date.getDate()," ",ne?"• Today":""]}),t("div",{css:b4(e),children:tc[m.date.getDay()]}),te.length===0?t("p",{css:y4,children:"Click to add"}):te.map($e=>{const S=Ma($e),K=Qa[S];return r("div",{css:w4(K.bar),onClick:se=>{se.stopPropagation(),J($e)},onKeyDown:se=>se.stopPropagation(),role:"presentation",children:[t(lt,{}),Ji($e),t("span",{style:{opacity:.95,fontWeight:600},children:In($e.start_time)})]},$e.id)}),Ce>0&&r("div",{style:{fontSize:"0.65rem",color:"#6b7280",marginTop:2},children:["+",Ce," more"]})]},O)})]}):n==="weekly"?r("div",{css:v4(e),children:[r("div",{css:x4,children:[t("div",{css:S4(e)}),T.map(m=>r("div",{css:$4(e,Mx(m,re)),children:[tc[m.getDay()],t("div",{style:{fontWeight:500,fontSize:"0.75rem",opacity:.85},children:m.getDate()})]},Ot(m)))]}),r("div",{css:C4,children:[t("div",{css:_4(e),children:h.map(m=>r("div",{css:A4(e),style:{top:(m-Es)*go},children:[String(m).padStart(2,"0"),":00"]},m))}),T.map(m=>{const $=Ot(m);return t("div",{css:L4(e,$===xe),children:(D[$]||[]).map(O=>{const ne=Q4(O);if(!ne)return null;const k=Ma(O),te=Qa[k],Ce=O.entry_type==="event";return r("div",{role:"button",tabIndex:0,css:N4(e,ne.top,ne.height,te.bar,te.bg),onClick:()=>J(O),onKeyDown:$e=>$e.key==="Enter"&&J(O),children:[Ce&&t(Er,{style:{width:11,height:11,opacity:.9,marginBottom:2,display:"block"}}),t("div",{style:{fontWeight:800},children:Ji(O)}),r("div",{style:{fontWeight:500,opacity:.95,marginTop:2},children:[In(O.start_time)," – ",In(O.end_time)]}),O.room_location&&r("div",{style:{display:"flex",alignItems:"center",gap:4,marginTop:4,fontWeight:600,opacity:.9},children:[t(Tn,{style:{width:12,height:12}}),O.room_location]}),(O.lecturers||[]).length>0&&r("div",{style:{display:"flex",alignItems:"center",gap:4,marginTop:2,fontWeight:500,fontSize:"0.68rem",opacity:.95},children:[t(nr,{style:{width:12,height:12}}),O.lecturers[0].full_name,(O.lecturers||[]).length>1?"…":""]})]},O.id)})},$)})]})]}):t("div",{children:ae.length===0?t("p",{css:Cu(e),children:"No entries in this range. Use Add Entry or pick another week."}):ae.map(({date:m,items:$})=>{const O=yu(m),ne=m===xe,k=O.toLocaleDateString(void 0,{weekday:"long",month:"short",day:"numeric"});return r("div",{css:D4(e),children:[r("div",{css:z4(e,ne),children:[t(wn,{"aria-hidden":!0}),k,ne&&t("span",{css:E4(e),children:"Today"}),r("span",{css:T4(e),children:[$.length," ",$.length===1?"entry":"entries"]})]}),$.map(te=>{const Ce=Ma(te),$e=Qa[Ce];return t("div",{css:j4(e,$e.bar),children:r("div",{css:R4,children:[r("div",{style:{minWidth:0,flex:1},children:[r("div",{style:{display:"flex",alignItems:"center",flexWrap:"wrap",gap:"0.35rem"},children:[te.entry_type==="event"?t(Er,{style:{width:18,height:18,color:$e.bar}}):t(St,{style:{width:18,height:18,color:$e.bar}}),t("span",{style:{fontWeight:700,fontSize:"0.95rem"},children:te.entry_type==="class"?`${Ji(te)} – ${te.course_name||"Module"}`:Ji(te)}),t("span",{css:P4(e),children:te.entry_type==="class"?"Class":"Event"})]}),te.entry_type==="event"&&te.event_description&&t("p",{style:{margin:"0.35rem 0 0 0",fontSize:"0.85rem",opacity:.85},children:te.event_description}),r("div",{css:B4(e),children:[r("span",{children:[t(lt,{}),In(te.start_time)," – ",In(te.end_time)]}),te.room_location&&r("span",{children:[t(Tn,{}),te.room_location]}),(te.lecturers||[]).length>0&&r("span",{children:[t(nr,{}),(te.lecturers||[]).map(S=>S.full_name).join(", ")]})]})]}),r("div",{css:O4,children:[t("button",{type:"button",css:rc(e,!1),title:"Edit",onClick:()=>J(te),children:t(yn,{})}),t("button",{type:"button",css:rc(e,!0),title:"Delete",onClick:()=>he(te),children:t(bn,{})})]})]})},te.id)})]},m)})}),W&&t("div",{css:I4,role:"presentation",onClick:G,children:r("div",{css:k4(e),onClick:m=>m.stopPropagation(),children:[t("div",{css:F4(e),children:r("div",{css:Y4,children:[r("div",{children:[t("h3",{css:U4(e),children:V?"Edit Timetable Entry":"Add New Timetable Entry"}),t("p",{css:$u(e),children:"Create or update a class or school event."})]}),t("button",{type:"button",css:rc(e,!1),onClick:G,"aria-label":"Close",children:t(Fe,{})})]})}),r("div",{css:W4,children:[r("div",{css:Gt,children:[t("label",{css:Rt(e),children:"Entry Type"}),r("select",{css:Zi(e),value:H.entry_type,onChange:m=>{const $=m.target.value==="event"?"event":"class";Q(O=>({...O,entry_type:$,lecturer_ids:$==="event"?[]:O.entry_type==="event"?[]:O.lecturer_ids}))},children:[t("option",{value:"class",children:"Class"}),t("option",{value:"event",children:"School Event"})]})]}),H.entry_type==="class"?r("div",{css:Gt,children:[t("label",{css:Rt(e),children:"Module"}),r("select",{css:Zi(e),value:H.course_id,onChange:m=>{const $=m.target.value,O=P.find(te=>String(te.id)===$),ne=ec(O,A),k=ne.length===1?[ne[0].id]:[];Q(te=>({...te,course_id:$,lecturer_ids:k}))},children:[t("option",{value:"",children:"Select module"}),P.map(m=>r("option",{value:String(m.id),children:[m.course_code," — ",m.course_name]},m.id))]})]}):r(rt,{children:[r("div",{css:Gt,children:[t("label",{css:Rt(e),children:"Event Title"}),t("input",{type:"text",css:Yn(e),placeholder:"e.g. Annual Sports Day",value:H.event_title,onChange:m=>Q($=>({...$,event_title:m.target.value}))})]}),r("div",{css:Gt,children:[t("label",{css:Rt(e),children:"Event Description"}),t("textarea",{css:G4(e),placeholder:"Brief description of the event",value:H.event_description,onChange:m=>Q($=>({...$,event_description:m.target.value}))})]})]}),r("div",{css:Gt,children:[t("label",{css:Rt(e),children:"Specific Date"}),t("input",{type:"date",css:Yn(e),value:H.entry_date,onChange:m=>Q($=>({...$,entry_date:m.target.value}))}),t("p",{css:$u(e),style:{marginTop:"0.35rem"},children:"Select the specific date for this class or event."})]}),r("div",{css:Gt,children:[t("label",{css:Rt(e),children:"Day (auto-filled)"}),t("input",{type:"text",css:Yn(e),value:Y,readOnly:!0,disabled:!0,placeholder:"Will be set based on selected date"})]}),r("div",{css:J4,children:[r("div",{css:Gt,children:[t("label",{css:Rt(e),children:"Start Time"}),t("input",{type:"time",css:Yn(e),value:H.start_time,onChange:m=>Q($=>({...$,start_time:m.target.value}))})]}),r("div",{css:Gt,children:[t("label",{css:Rt(e),children:"End Time"}),t("input",{type:"time",css:Yn(e),value:H.end_time,onChange:m=>Q($=>({...$,end_time:m.target.value}))})]})]}),r("div",{css:Gt,children:[t("label",{css:Rt(e),children:"Room / Location"}),t("input",{type:"text",css:Yn(e),placeholder:"e.g. CS-101, Lab 3",value:H.room_location,onChange:m=>Q($=>({...$,room_location:m.target.value}))})]}),H.entry_type==="class"&&r("div",{css:Gt,children:[t("label",{css:Rt(e),children:"Lecturer(s) for this module"}),t("div",{css:Z4(e),children:H.course_id?E.length===0?t("span",{style:{fontSize:"0.85rem",opacity:.8},children:"This module has no linked lecturer. Assign one in the Courses section."}):E.map(m=>r("label",{css:q4,children:[t("input",{type:"checkbox",checked:H.lecturer_ids.includes(m.id),onChange:()=>me(m.id)}),m.full_name,m.department?` (${m.department})`:""]},m.id)):t("span",{style:{fontSize:"0.85rem",opacity:.8},children:"Select a module to see assigned lecturer(s)."})})]})]}),r("div",{css:H4(e),children:[t("button",{type:"button",css:V4(e),onClick:G,children:"Cancel"}),t("button",{type:"button",css:K4,onClick:ye,disabled:R,children:R?"Saving…":V?"Save Changes":"Create Entry"})]})]})})]})}const eS="/strack/".replace(/\/$/,""),_u=["#7c3aed","#2563eb","#0891b2","#059669","#65a30d","#ca8a04","#ea580c","#dc2626","#db2777","#4f46e5","#0d9488","#15803d","#b45309","#be185d","#475569","#a855f7"],tS=s`
  display: flex;
  flex-direction: column;
  gap: 1.25rem;
  width: 100%;
